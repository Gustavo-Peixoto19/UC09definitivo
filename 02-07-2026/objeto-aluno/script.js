...
let celular = {
  modelo: "Motorola 60 fusion",
  preco: 3000
};
celular.preco = 2999;
celular.cor = "prateado";
...
function apresentador(alpha){
  mostrar("saida3", alpha.nome + "faz " + alpha.curso + " no Senac " + alpha.unidade)
}
apresentador(aluno)
...
let item1 = criarProduto("Pastel de queijo", 8);
let item2 = criarProduto("Caldo de cana", 5)
mostrar("saida6", 
  item1.nome + ": R$ " + item1.preco + "\n" +
  item2.nome + ": R$ " + item2.preco
);
...
mostrar("saida7", "O total do pedido é " + total + "R$ ");
