...
let nome = ("Gustavo");
let idade = ("19");
let bairro = ("Jardim Malia Amalia");
...
console.log("A minha média é de " + media)
...
let pedacos = Number(8)
let pessoas = Number(3)

let sobra = (pedacos % pessoas)

console.log("A quantidade de pizzas que vão sobrar é " + sobra)
...
console.log ("Resultado com && " + (temRG && temDinheiro))
console.log ("Resultado com || " + (temRG || temDinheiro))
...
console.log("saldoBanco mudou para", saldoBanco, "| cpf continua", cpf);
 ...
 // O erro é: Atribuição a uma variável constante.
...
console.log("Oi o meu nome é " + nome + ", eu tenho " + idade + " e eu moro no bairro " + bairro)
...
document.getElementById("saida"). textContent = "Oi o meu nome é " + nome + ", eu tenho " + idade + " e eu moro no bairro " + bairro
...
function aoClicar() {
  ...
  document.getElementById("saida").textContent = "Bem-vindo(a), " + nomeUsuario + "!";
}
